  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Filter articles where the backend ID matches localStorage IDs
        // const matchedArticles = response.data.filter(article => likedArticleIds.includes(article.id));

        // Update state with only matched articles
        setFilteredData(response.data.katturaiList);
        console.log(response.data.katturaiList)
      } catch (error) {
