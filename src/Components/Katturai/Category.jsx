      ...
      className="block">
        ...
        <div className="relative group w-full h-40 overflow-hidden rounded-t-lg">
          ...
          <div className="absolute inset-0 flex items-end justify-start opacity-0 group-hover:opacity-100 transition-all duration-500 ease-in-out">
            <h3 className="text-white font-bold text-lg  px-4 py-2  bg-opacity-60 rounded-lg transform scale-90 group-hover:scale-100 text-left">{category.cat_name}</h3>
        ...
        <div className="p-3 text-center">
          <h2 className="text-lg font-semibold text-blue-600">{category.cat_name}</h2>
